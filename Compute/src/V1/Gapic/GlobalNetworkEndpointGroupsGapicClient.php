...
class GlobalNetworkEndpointGroupsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/global_network_endpoint_groups_grpc_config.json',
            'credentialsConfig' => [
     ...
     * try {
     *     $project = '';
     *     $response = $globalNetworkEndpointGroupsClient->list_($project);
     * } finally {
     *     $globalNetworkEndpointGroupsClient->close();
     * }
     * ```
     ...
     *     $networkEndpointGroup = '';
     *     $project = '';
     *     $response = $globalNetworkEndpointGroupsClient->listNetworkEndpoints($networkEndpointGroup, $project);
     * } finally {
     *     $globalNetworkEndpointGroupsClient->close();
     * }
     * ```
