...
class RegionTargetHttpProxiesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionTargetHttpProxies/Delete', $actualFuncCall);
    ...
    public function insertTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionTargetHttpProxies/Insert', $actualFuncCall);
    ...
    public function setUrlMapTest()
    {
        ...
        $response = $client->setUrlMap();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionTargetHttpProxies/SetUrlMap', $actualFuncCall);
