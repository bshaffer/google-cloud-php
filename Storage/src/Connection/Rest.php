...
use Google\Cloud\Core\HttpMiddleware\RangeHeadersHttpMiddleware;
...
class Rest implements ConnectionInterface
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $config['httpHandler'] =
            // Wrap the httpHandler in the RangeHeadersHttpMiddleware
            new RangeHeadersHttpMiddleware(
                // Wrap the httpHandler in the RetryHeadersHttpMiddleware
                new RetryHeadersHttpMiddleware(
