 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.AddressList</code>
 */
class AddressList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Address items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Address[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of Address resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#addressList for lists of addresses.
