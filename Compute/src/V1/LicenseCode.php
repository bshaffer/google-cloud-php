...
class LicenseCode extends \Google\Protobuf\Internal\Message
{
    ...
    protected $kind = '';
    /**
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.LicenseCodeLicenseAlias license_alias = 5;</code>
     */
    ...
    protected $self_link = '';
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.LicenseCode.State state = 8;</code>
     */
    protected $state = 0;
    /**
     * Generated from protobuf field <code>bool transferable = 9;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\LicenseCode_State::class);
        $this->state = $var;
