 ...
 * try {
 *     $response = $interconnectAttachmentsClient->aggregatedList();
 * } finally {
...
class InterconnectAttachmentsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/interconnect_attachments_grpc_config.json',
            'credentialsConfig' => [
    ...
    public function aggregatedList(array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'AggregatedList',
            InterconnectAttachmentAggregatedList::class,
            $optionalArgs,
            $request
        )->wait();
    }
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $response = $interconnectAttachmentsClient->delete();
     * } finally {
     *     $interconnectAttachmentsClient->close();
     * }
     * ```.
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $response = $interconnectAttachmentsClient->insert();
     * } finally {
     *     $interconnectAttachmentsClient->close();
     * }
     * ```.
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $response = $interconnectAttachmentsClient->list_();
     * } finally {
     *     $interconnectAttachmentsClient->close();
     * }
     * ```.
    ...
    public function list_(array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'List',
            InterconnectAttachmentList::class,
            $optionalArgs,
            $request
        )->wait();
    }
