 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.UpdateNetworkInterfaceInstanceRequest</code>
 */
class UpdateNetworkInterfaceInstanceRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.NetworkInterface network_interface_resource = 325814789;</code>
     */
    ...
    {
        return isset($this->network_interface_resource) ? $this->network_interface_resource : null;
    }

    public function hasNetworkInterfaceResource()
    {
        return isset($this->network_interface_resource);
    }

    public function clearNetworkInterfaceResource()
    {
        unset($this->network_interface_resource);
    }
     ...
     * @return $this
     */
    public function setNetworkInterfaceResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\NetworkInterface::class);
        $this->network_interface_resource = $var;
