...
class RegionTargetHttpsProxiesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/region_target_https_proxies_grpc_config.json',
            'credentialsConfig' => [
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionTargetHttpsProxiesClient->insert($project, $region);
     * } finally {
     *     $regionTargetHttpsProxiesClient->close();
     * }
     * ```
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionTargetHttpsProxiesClient->list_($project, $region);
     * } finally {
     *     $regionTargetHttpsProxiesClient->close();
     * }
     * ```
     ...
     *     $region = '';
     *     $targetHttpsProxy = '';
     *     $response = $regionTargetHttpsProxiesClient->setSslCertificates($project, $region, $targetHttpsProxy);
     * } finally {
     *     $regionTargetHttpsProxiesClient->close();
     * }
     * ```
     ...
     *     $region = '';
     *     $targetHttpsProxy = '';
     *     $response = $regionTargetHttpsProxiesClient->setUrlMap($project, $region, $targetHttpsProxy);
     * } finally {
     *     $regionTargetHttpsProxiesClient->close();
     * }
     * ```
