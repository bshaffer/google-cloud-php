 ...
 * try {
 *     $response = $regionCommitmentsClient->aggregatedList();
 * } finally {
...
class RegionCommitmentsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/region_commitments_grpc_config.json',
            'credentialsConfig' => [
    ...
    public function aggregatedList(array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'AggregatedList',
            CommitmentAggregatedList::class,
            $optionalArgs,
            $request
        )->wait();
    }
     ...
     * $regionCommitmentsClient = new RegionCommitmentsClient();
     * try {
     *     $response = $regionCommitmentsClient->get();
     * } finally {
     *     $regionCommitmentsClient->close();
     * }
     * ```.
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['commitment'])) {
            $request->setCommitment($optionalArgs['commitment']);
        }
        if (isset($optionalArgs['project'])) {
            $request->setProject($optionalArgs['project']);
        }
     ...
     * $regionCommitmentsClient = new RegionCommitmentsClient();
     * try {
     *     $response = $regionCommitmentsClient->list_();
     * } finally {
     *     $regionCommitmentsClient->close();
     * }
     * ```.
