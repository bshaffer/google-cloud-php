...
{
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.LogConfigDataAccessOptions.LogMode log_mode = 1;</code>
     */
    protected $log_mode = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\LogConfigDataAccessOptions_LogMode::class);
        $this->log_mode = $var;
