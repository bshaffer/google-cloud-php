...
class InterconnectLocationsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/interconnect_locations_grpc_config.json',
            'credentialsConfig' => [
     ...
     *
     *     @type string $project
     *     @type string $interconnectLocation
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['interconnectLocation'])) {
            $request->setInterconnectLocation($optionalArgs['interconnectLocation']);
        }
     ...
     * $interconnectLocationsClient = new InterconnectLocationsClient();
     * try {
     *     $response = $interconnectLocationsClient->list_();
     * } finally {
     *     $interconnectLocationsClient->close();
     * }
     * ```.
