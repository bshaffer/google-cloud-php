...
class SslPoliciesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/ssl_policies_grpc_config.json',
            'credentialsConfig' => [
     ...
     * $sslPoliciesClient = new SslPoliciesClient();
     * try {
     *     $response = $sslPoliciesClient->list_();
     * } finally {
     *     $sslPoliciesClient->close();
     * }
     * ```.
    ...
    public function listAvailableFeatures(array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            ...
            SslPoliciesListAvailableFeaturesResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
