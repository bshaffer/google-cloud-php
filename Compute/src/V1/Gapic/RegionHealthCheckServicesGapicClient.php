...
class RegionHealthCheckServicesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/region_health_check_services_grpc_config.json',
            'credentialsConfig' => [
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionHealthCheckServicesClient->insert($project, $region);
     * } finally {
     *     $regionHealthCheckServicesClient->close();
     * }
     * ```
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionHealthCheckServicesClient->list_($project, $region);
     * } finally {
     *     $regionHealthCheckServicesClient->close();
     * }
     * ```
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionHealthCheckServicesClient->patch($healthCheckService, $project, $region);
     * } finally {
     *     $regionHealthCheckServicesClient->close();
     * }
     * ```
