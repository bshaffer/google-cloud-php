 ...
 * try {
 *     $response = $vpnGatewaysClient->aggregatedList();
 * } finally {
...
class VpnGatewaysGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/vpn_gateways_grpc_config.json',
            'credentialsConfig' => [
     ...
     * $vpnGatewaysClient = new VpnGatewaysClient();
     * try {
     *     $response = $vpnGatewaysClient->delete();
     * } finally {
     *     $vpnGatewaysClient->close();
     * }
     * ```.
     ...
     * $vpnGatewaysClient = new VpnGatewaysClient();
     * try {
     *     $response = $vpnGatewaysClient->list_();
     * } finally {
     *     $vpnGatewaysClient->close();
     * }
     * ```.
     ...
     * $vpnGatewaysClient = new VpnGatewaysClient();
     * try {
     *     $response = $vpnGatewaysClient->setLabels();
     * } finally {
     *     $vpnGatewaysClient->close();
     * }
     * ```.
