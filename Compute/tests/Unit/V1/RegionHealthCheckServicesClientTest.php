...
class RegionHealthCheckServicesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionHealthCheckServices/Delete', $actualFuncCall);
    ...
    public function deleteExceptionTest()
    {
        ...
        try {
            $client->delete($healthCheckService, $project, $region);
    ...
    public function insertTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthCheckServices/Insert', $actualFuncCall);
    ...
    public function patchTest()
    {
        ...
        $response = $client->patch($healthCheckService, $project, $region);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthCheckServices/Patch', $actualFuncCall);
    ...
    public function patchExceptionTest()
    {
        ...
        try {
            $client->patch($healthCheckService, $project, $region);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
