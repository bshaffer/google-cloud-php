...
/**
 * Generated from protobuf message <code>google.cloud.compute.v1.SubnetworkList</code>
 */
class SubnetworkList extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Subnetwork items = 2;</code>
     */
    private $items;
    /**
     ...
     *
     *     @type string $id
     *     @type \Google\Cloud\Compute\V1\Subnetwork[]|\Google\Protobuf\Internal\RepeatedField $items
     *     @type string $kind
