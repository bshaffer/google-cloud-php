 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.BackendServiceList</code>
 */
class BackendServiceList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendService items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\BackendService[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of BackendService resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#backendServiceList for lists of backend services.
