...
class ServiceBuilder
{
    ...
    /**
     * Cloud Spanner client. Cloud Spanner is a highly scalable, transactional,
     * managed, NewSQL database service. Find more information at
     * [Cloud Spanner API docs](https://cloud.google.com/spanner/).
     *
     * Example:
     * ```
