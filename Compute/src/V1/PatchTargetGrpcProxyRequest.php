 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchTargetGrpcProxyRequest</code>
 */
class PatchTargetGrpcProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return isset($this->target_grpc_proxy_resource) ? $this->target_grpc_proxy_resource : null;
    }
