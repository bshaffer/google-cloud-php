...
class Key implements JsonSerializable
{
     ...
     */
    public function pathElement(string $kind, $identifier = null, array $options = []): Key
    {
        $options += [
            'identifierType' => null
        ];
     ...
     * @return array
     */
    private function normalizeElement(string $kind, $identifier, ?string $identifierType): array
    {
