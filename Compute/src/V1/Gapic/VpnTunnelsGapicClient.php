...
class VpnTunnelsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/vpn_tunnels_grpc_config.json',
            'credentialsConfig' => [
     ...
     * $vpnTunnelsClient = new VpnTunnelsClient();
     * try {
     *     $response = $vpnTunnelsClient->delete();
     * } finally {
     *     $vpnTunnelsClient->close();
     * }
     * ```.
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['vpnTunnel'])) {
            $request->setVpnTunnel($optionalArgs['vpnTunnel']);
        }
     ...
     *     @type string $region
     *     @type string $requestId
     *     @type VpnTunnel $vpnTunnelResource
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
    ...
    public function insert(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['vpnTunnelResource'])) {
            $request->setVpnTunnelResource($optionalArgs['vpnTunnelResource']);
        }
     ...
     * $vpnTunnelsClient = new VpnTunnelsClient();
     * try {
     *     $response = $vpnTunnelsClient->list_();
     * } finally {
     *     $vpnTunnelsClient->close();
     * }
     * ```.
