 ...
 * try {
 *     $response = $targetInstancesClient->aggregatedList();
 * } finally {
...
class TargetInstancesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/target_instances_grpc_config.json',
            'credentialsConfig' => [
     ...
     * $targetInstancesClient = new TargetInstancesClient();
     * try {
     *     $response = $targetInstancesClient->delete();
     * } finally {
     *     $targetInstancesClient->close();
     * }
     * ```.
     ...
     * $targetInstancesClient = new TargetInstancesClient();
     * try {
     *     $response = $targetInstancesClient->list_();
     * } finally {
     *     $targetInstancesClient->close();
     * }
     * ```.
