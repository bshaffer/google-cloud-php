 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RouterList</code>
 */
class RouterList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Router items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Router[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of Router resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#router for routers.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\Router::class);
        $this->items = $arr;
