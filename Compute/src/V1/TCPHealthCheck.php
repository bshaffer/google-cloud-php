...
class TCPHealthCheck extends \Google\Protobuf\Internal\Message
{
    ...
    protected $port_name = '';
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.TCPHealthCheck.PortSpecification port_specification = 3;</code>
     */
    protected $port_specification = 0;
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.TCPHealthCheck.ProxyHeader proxy_header = 4;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\TCPHealthCheck_PortSpecification::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\TCPHealthCheck_ProxyHeader::class);
