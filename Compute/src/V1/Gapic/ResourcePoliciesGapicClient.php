...
class ResourcePoliciesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/resource_policies_grpc_config.json',
            'credentialsConfig' => [
    ...
    public function aggregatedList(array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'AggregatedList',
            ResourcePolicyAggregatedList::class,
            $optionalArgs,
            $request
        )->wait();
    }
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['resourcePolicy'])) {
            $request->setResourcePolicy($optionalArgs['resourcePolicy']);
        }
        if (isset($optionalArgs['project'])) {
            $request->setProject($optionalArgs['project']);
        }
     ...
     * $resourcePoliciesClient = new ResourcePoliciesClient();
     * try {
     *     $response = $resourcePoliciesClient->getIamPolicy();
     * } finally {
     *     $resourcePoliciesClient->close();
     * }
     * ```.
     ...
     * $resourcePoliciesClient = new ResourcePoliciesClient();
     * try {
     *     $response = $resourcePoliciesClient->list_();
     * } finally {
     *     $resourcePoliciesClient->close();
     * }
     * ```.
