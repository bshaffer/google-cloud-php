...
class RegionInstanceGroupsGapicClient
{
     ...
     *     $region = '';
     *     // Iterate over pages of elements
     *     $pagedResponse = $regionInstanceGroupsClient->listInstances($instanceGroup, $project, $region);
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listInstances($instanceGroup, $project, $region, array $optionalArgs = [])
    {
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionInstanceGroupsClient->setNamedPorts($instanceGroup, $project, $region);
     * } finally {
     *     $regionInstanceGroupsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function setNamedPorts($instanceGroup, $project, $region, array $optionalArgs = [])
    {
