 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RegionInstanceGroupManagerList</code>
 */
class RegionInstanceGroupManagerList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InstanceGroupManager items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\InstanceGroupManager[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of InstanceGroupManager resources.
     *     @type string $kind
     *           [Output Only] The resource type, which is always compute#instanceGroupManagerList for a list of managed instance groups that exist in th regional scope.
