...
class HealthChecksGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/health_checks_grpc_config.json',
            'credentialsConfig' => [
     ...
     * try {
     *     $project = '';
     *     $response = $healthChecksClient->insert($project);
     * } finally {
     *     $healthChecksClient->close();
     * }
     * ```
     ...
     *     $healthCheck = '';
     *     $project = '';
     *     $response = $healthChecksClient->patch($healthCheck, $project);
     * } finally {
     *     $healthChecksClient->close();
     * }
     * ```
     ...
     *     $healthCheck = '';
     *     $project = '';
     *     $response = $healthChecksClient->update($healthCheck, $project);
     * } finally {
     *     $healthChecksClient->close();
     * }
     * ```
