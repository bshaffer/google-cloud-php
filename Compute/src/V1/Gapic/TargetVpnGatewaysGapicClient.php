...
class TargetVpnGatewaysGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/target_vpn_gateways_grpc_config.json',
            'credentialsConfig' => [
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $targetVpnGatewaysClient->insert($project, $region);
     * } finally {
     *     $targetVpnGatewaysClient->close();
     * }
     * ```
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $targetVpnGatewaysClient->list_($project, $region);
     * } finally {
     *     $targetVpnGatewaysClient->close();
     * }
     * ```
