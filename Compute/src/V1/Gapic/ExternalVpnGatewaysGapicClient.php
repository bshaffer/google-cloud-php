...
class ExternalVpnGatewaysGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/external_vpn_gateways_grpc_config.json',
            'credentialsConfig' => [
     ...
     * try {
     *     $project = '';
     *     $response = $externalVpnGatewaysClient->list_($project);
     * } finally {
     *     $externalVpnGatewaysClient->close();
     * }
     * ```
