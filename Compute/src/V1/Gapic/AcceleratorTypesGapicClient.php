...
class AcceleratorTypesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/accelerator_types_grpc_config.json',
            'credentialsConfig' => [
    ...
    public function aggregatedList(array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'AggregatedList',
            AcceleratorTypeAggregatedList::class,
            $optionalArgs,
            $request
        )->wait();
    }
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['acceleratorType'])) {
            $request->setAcceleratorType($optionalArgs['acceleratorType']);
        }
     ...
     * $acceleratorTypesClient = new AcceleratorTypesClient();
     * try {
     *     $response = $acceleratorTypesClient->list_();
     * } finally {
     *     $acceleratorTypesClient->close();
     * }
     * ```.
