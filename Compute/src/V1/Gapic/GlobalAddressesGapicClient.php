 ...
 * try {
 *     $response = $globalAddressesClient->delete();
 * } finally {
...
class GlobalAddressesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/global_addresses_grpc_config.json',
            'credentialsConfig' => [
     ...
     * $globalAddressesClient = new GlobalAddressesClient();
     * try {
     *     $response = $globalAddressesClient->insert();
     * } finally {
     *     $globalAddressesClient->close();
     * }
     * ```.
     ...
     * $globalAddressesClient = new GlobalAddressesClient();
     * try {
     *     $response = $globalAddressesClient->list_();
     * } finally {
     *     $globalAddressesClient->close();
     * }
     * ```.
