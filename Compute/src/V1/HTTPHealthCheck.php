...
class HTTPHealthCheck extends \Google\Protobuf\Internal\Message
{
    ...
    protected $port_name = '';
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.HTTPHealthCheck.PortSpecification port_specification = 4;</code>
     */
    protected $port_specification = 0;
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.HTTPHealthCheck.ProxyHeader proxy_header = 5;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\HTTPHealthCheck_PortSpecification::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\HTTPHealthCheck_ProxyHeader::class);
