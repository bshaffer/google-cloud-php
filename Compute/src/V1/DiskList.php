 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.DiskList</code>
 */
class DiskList extends \Google\Protobuf\Internal\Message
{
     ...
     * A list of Disk resources.
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Disk items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Disk[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of Disk resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#diskList for lists of disks.
