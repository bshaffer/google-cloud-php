...
class RegionOperationsGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__.'/../resources/region_operations_grpc_config.json',
            'credentialsConfig' => [
    ...
    public function delete($operation, $project, $region, array $optionalArgs = [])
    {
        ...
        return $this->startCall(
            'Delete',
            DeleteRegionOperationResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
     ...
     *     $project = '';
     *     $region = '';
     *     $response = $regionOperationsClient->list_($project, $region);
     * } finally {
     *     $regionOperationsClient->close();
     * }
     * ```
