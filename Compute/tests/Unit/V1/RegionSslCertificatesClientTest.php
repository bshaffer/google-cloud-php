...
class RegionSslCertificatesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionSslCertificates/Delete', $actualFuncCall);
    ...
    public function insertTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionSslCertificates/Insert', $actualFuncCall);
