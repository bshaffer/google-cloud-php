...
class TargetHttpsProxy extends \Google\Protobuf\Internal\Message
{
    ...
    protected $name = '';
    /**
     * Generated from protobuf field <code>.google.cloud.compute.v1.TargetHttpsProxy.QuicOverride quic_override = 6;</code>
     */
    protected $quic_override = 0;
    /**
    ...
    /**
     * Generated from protobuf field <code>string url_map = 11;</code>
     */
    protected $url_map = '';
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\TargetHttpsProxy_QuicOverride::class);
