 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.UpdateDisplayDeviceInstanceRequest</code>
 */
class UpdateDisplayDeviceInstanceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->display_device_resource) ? $this->display_device_resource : null;
    }

    public function hasDisplayDeviceResource()
    {
        return isset($this->display_device_resource);
    }

    public function clearDisplayDeviceResource()
    {
        unset($this->display_device_resource);
    }
     ...
     * @return $this
     */
    public function setDisplayDeviceResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\DisplayDevice::class);
        $this->display_device_resource = $var;
